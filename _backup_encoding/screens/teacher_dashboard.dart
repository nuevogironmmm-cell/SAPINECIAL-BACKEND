...
import '../widgets/psalm1_preface_widget.dart';
...
class _TeacherDashboardState extends State<TeacherDashboard>
  ...
  Widget _buildSlideContent(Slide slide) {
    ...
    if (slide.id == 'salmo1_preface_cinematic') { return const Psalm1PrefaceWidget(); }
    if (slide.id == 'imprecatory_psalms_activity') {
      return ImprecatoryPsalmsWidget(
        revealAnswers: slide.activity?.isRevealed ?? false,
      );
    }
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: (isCorrect && slide.activity!.isRevealed 
                                  ? Colors.green 
                                  : const Color(0xFFC5A065)).withValues(alpha: 0.4),
                              blurRadius: 8,
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (isSelected)
              BoxShadow(
                color: const Color(0xFFC5A065).withValues(alpha: 0.5),
                blurRadius: 12,
                spreadRadius: 2
              )
          ]
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, idx) {
                    ...
                    return Container(
                      margin: const EdgeInsets.only(bottom: 8),
                      decoration: BoxDecoration(
                        color: isSelected ? const Color(0xFFC5A065).withValues(alpha: 0.2) : Colors.white.withValues(alpha: 0.05),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
