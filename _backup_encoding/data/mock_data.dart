...
final unitSalmosSession = ClassSession(
  ...
  blocks: [
    ...
    ClassBlock(
      title: 'Salmo 1 e Imprecatorios',
      slides: [
        Slide(
          id: 'salmo1_preface_cinematic',
          type: SlideType.content,
          title: 'Salmo 1: El Prefacio',
          content: 'Introducción visual al Salmo 1.',
        ),
        Slide(
          id: 'imprecatory_psalms_activity',
          type: SlideType.activity,
          title: 'Actividad 2 – Clasifica el texto',
          content: 'Identifica si cada texto es Imprecatorio, Lamento o Alabanza. Las respuestas solo se revelan cuando el docente lo ordene.',
          activity: ActivityData(
            question: 'Clasifica cada texto en: Imprecatorio, Lamento o Alabanza.',
            options: ['Imprecatorio', 'Lamento', 'Alabanza'],
            correctOptionIndex: 0,
            explanation: 'Revisión guiada por el docente.',
          ),
        ),
      ],
    ),
...
final List<ClassSession> availableUnits = [unit1Session, unit2Session, unitSalmosSession];
