...
/// =============================================================================
/// SALMOS IMPRECATORIOS — WIDGET 3D INTERACTIVO PARA PROYECCIÓN
...
class _ImprecatoryPsalmsWidgetState extends State<ImprecatoryPsalmsWidget>
  ...
  final List<Map<String, String>> _psalms = [
    {
      ...
      'author': 'David',
      'verse': '«Pelea, oh Jehová, contra los que me combaten; combate a los que me guerrean.»',
    ...
    },
    {
      ...
      'author': 'David',
      'verse': '«¿Es verdad que pronunciáis justicia, oh congregación? ¿Juzgáis rectamente, hijos de los hombres?»',
      'reference': 'Salmo 58:1',
      'context': 'Denuncia contra gobernantes y jueces que pervierten la justicia. Pide a Dios que intervenga contra la corrupción.',
    ...
    },
    {
      ...
      'author': 'David',
      'verse': '«Sálvame, oh Dios, porque las aguas han entrado hasta el alma.»',
      'reference': 'Salmo 69:1',
      'context': 'Uno de los más citados en el Nuevo Testamento. Profecía mesiánica del sufrimiento de Cristo.',
    ...
    },
    {
      ...
      'author': 'Asaf',
      'verse': '«Oh Dios, no guardes silencio; no calles, oh Dios, ni te estés quieto.»',
      'reference': 'Salmo 83:1',
      'context': 'Oración colectiva contra una coalición de naciones que buscan destruir a Israel.',
      'image': 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=3840',
    },
    {
      'number': '109',
      'title': 'El más intenso — Contra el traidor',
      'author': 'David',
      'verse': '«Oh Dios de mi alabanza, no calles; porque boca de impío y boca de engañador se han abierto contra mí.»',
      'reference': 'Salmo 109:1-2',
      'context': 'Considerado el más intenso. Pedro lo aplica a Judas en Hechos 1:20.',
      'image': 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=3840',
    },
    {
      'number': '137',
      'title': 'Lamento del exilio en Babilonia',
      'author': 'Anónimo (exílico)',
      'verse': '«Junto a los ríos de Babilonia, allí nos sentábamos, y aun llorábamos, acordándonos de Sion.»',
  ...
  // Páginas: Título + Definición + 6 Salmos + Nota David = 9
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Scaffold(
          ...
          body: Stack(
            children: [
              // Fondo animado 3D con partículas
              _build3DBackground(),
  ...
  // ==========================================================================
  // FONDO 3D ANIMADO CON PARTÍCULAS Y GRADIENT
  // ==========================================================================
  ...
  // ==========================================================================
  // PÁGINA 1: TÍTULO CON EFECTO 3D FLOTANTE
  // ==========================================================================
  ...
  // ==========================================================================
  // PÁGINA 2: DEFINICIÓN CON TARJETA 3D
  // ==========================================================================
  ...
  // ==========================================================================
  // PÁGINAS 3-8: SALMOS INDIVIDUALES CON PERSPECTIVA 3D
  // ==========================================================================
          ...
          child: Padding(
            ...
            child: AnimatedBuilder(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  // Número gigante con resplandor 3D
                  AnimatedBuilder(
                    animation: _glowAnimation,
                    builder: (context, child) {
                      return Container(
                  ...
                  // Tarjeta del versículo con cristal 3D
                  Container(
                ...
                child: Column(
                  children: [
                    Text(
                      ...
                      'escritos por David, quien sufrió persecución '
                      'y traición. Como rey ungido por Dios, sus '
