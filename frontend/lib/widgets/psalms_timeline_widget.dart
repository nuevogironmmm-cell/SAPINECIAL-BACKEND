...
class _PsalmsTimelineWidgetState extends State<PsalmsTimelineWidget> {
  ...
  final List<_PsalmsMilestone> _milestones = [
    _PsalmsMilestone(
      ...
      title: 'Moisés',
      subtitle: 'El inicio',
      description: 'Salmo 90: El salmo más antiguo. Inicia la tradición poética de Israel.',
      color: Colors.amber,
    ...
    _PsalmsMilestone(
      ...
      description: 'El "Dulce Cantor de Israel". Compuso la mayoría de los salmos. Estableció la másica en el culto.',
      color: Colors.orange,
    ...
    _PsalmsMilestone(
      ...
      description: 'El rey Ezequías mandó recopilar los salmos de David y Asaf para el culto en el Templo.',
      color: Colors.deepPurple,
      icon: Icons.library_books,
    ),
    _PsalmsMilestone(
      year: '450 a.C.',
      title: 'Esdras y Nehemías',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '1000 a\u00f1os de alabanza (Mois\u00e9s a Esdras)',
          ...
          Align(
            ...
            child: TextButton.icon(
              ...
              label: const Text('Repetir Animación', style: TextStyle(color: Colors.white54)),
            ),
          )
        ],
      ),
